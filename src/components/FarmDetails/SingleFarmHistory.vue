  ...
  <v-row justify="center">
    ...
    >
      <v-card :dark="darkmode" class="pt-5">
        ...
        <v-card-text v-if="farmInfo.transactions" :set="(delta = farmInfo.transactions.totalDeposits - farmInfo.transactions.totalWithdrawls)">
            <v-row> 
                <v-col>
                    <v-row justify="center">
            ...
            <v-row>
                ...
                <v-col>
                    ...
                    <v-row justify="center">
                {{ ((farmInfo.poolData.actualStaked - delta) / delta) * 100 | to2Decimals(round)  }}%
                    </v-row>
                </v-col>
                <v-col>
                    <v-row justify="center">
            ...
            <v-row>
                <v-col>
                    ...
                    >
                        ...
                        >
                        <v-list-item-content>
                            <v-list-item-title v-text="item.token_transfer_amount"></v-list-item-title>
                        </v-list-item-content>
                        </v-list-item>
                    </v-list-item-group>
                    </v-list>
